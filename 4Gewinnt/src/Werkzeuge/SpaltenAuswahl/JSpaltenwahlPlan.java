...
/**
 * JComponent f�r den Plan f�r die Spaltenauswwahl, bestehend aus einem Array an Buttons
 * 
...
public class JSpaltenwahlPlan extends JPanel
{
	...
	/**
	 * Erzeugt mehrere Buttons f�r das ButtonArray
	 * 
	...
	/**
	 * F�gt componenten in der Reihe ein
	 * 
	 * @param component die einzuf�gende Komponnente 
	...
	/**
	 * F�gt einen Listener zur Spaltenauswahl hinzu
	 * 
	 * @param spaltenListener Der Listener der Hinzugef�gt werden soll
	 */
	...
	/**
	 * Erzeugt Listener f�r den Button
	 */
	...
	/**
	 * Informiert alle SpaltenAuswahlListener �ber das SpaltenAuswahlEvent
	 * 
	 * @param spalte Die ausgew�hlte Spalte
	 */
